...
namespace Application\BoardBundle;
...
class Helpers
{
    ...
    public function paginator($start, $total, $items_number, $link , $class = 0)
    {
        $first_index = 0;
	...
	if($total_pages <= 1)
	{
            $pages.='<li class="list-inline-item"><a class="active">1</a></li>';
	}
	else
	{
            ...
            if($start != 1 && $start != 0)
            {
                if($start == 2)
		{
                    $pages.='<li class="list-inline-item"><a class="nav" href="' . $link . '">назад</a></li>';
		}
		else
		{
                    $pages.='<li class="list-inline-item"><a class="nav" href="' . $link . '/'.($start-1).'">назад</a></li>';
		}
            }
		...
		else
		{
            ...
            if($start != $total_pages)
                $pages.='<li><a class="nav" href="' . $link . '/'.($start+1).'">вперед</a></li>';	
        }
	$pages.='</ul>';
	return $pages;
    }
